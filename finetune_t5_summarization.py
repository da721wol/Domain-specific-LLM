...
tokenizer = AutoTokenizer.from_pretrained("dwolpers/german_T5_Base_Open_Class")
model = T5ForConditionalGeneration.from_pretrained("dwolpers/german_T5_Base_Open_Class")

# Load the data collator
data_collator = DataCollatorForSeq2Seq(tokenizer=tokenizer, model=model)

prefix = "Fasse folgenden Text zusammen: "
...
training_args = Seq2SeqTrainingArguments(
  output_dir="dwolpers/german_T5_Base_Open_Summ",
